...
# (Stolen from a copy of Bonobo, which in turn stole it from some other
# part of GNOME, and so forth. This code is undoubtably GPL'd.)
...
(test -f $srcdir/configure.in \
  && test -d $srcdir/examples) || {
    ...
    echo " top-level xmlrpc-c directory"
    exit 1
}
